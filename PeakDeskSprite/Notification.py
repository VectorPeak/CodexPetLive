...
from PeakDeskSprite.utils import *
from PeakDeskSprite.conf import *
...
class SpriteNote(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        通知组件
        """
        super(SpriteNote, self).__init__(parent)
    ...
    def _show_notification(self, note_type, message=''):
        ...
        if message != '' and settings.toaster_on:
            ...
            if mergeable_type in self.type_dict.keys():
                ...
                self.note_dict[note_index] = SpriteToaster(note_index,
                                                        message=message,
                                                        icon=icon,
