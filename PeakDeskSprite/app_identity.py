...
CHARCOLLECT_LINK = os.environ.get(_env_name("CHARCOLLECT_LINK"), f"{PROJECT_URL}/releases")
ITEMCOLLECT_LINK = os.environ.get(_env_name("ITEMCOLLECT_LINK"), f"{PROJECT_URL}/releases")
PETCOLLECT_LINK = os.environ.get(_env_name("PETCOLLECT_LINK"), f"{PROJECT_URL}/releases")
