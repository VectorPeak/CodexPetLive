...
已有角色、物品模组和迷你宠物收录在 [素材与模组合集](docs/collection.md)，其中包含介绍与下载链接。下载后可以通过 App 导入使用

## 用户手册

用户手册仍在施工中。当前建议先通过 [Quick Start](#quick-start) 启动程序，再结合 [素材与模组合集](docs/collection.md) 和设置面板探索现有功能
...
**v0.3.4 - 12/13/2023**
- BUFF系统 init
  - 物品（包括宠物）添加了 ``buff`` 属性，详见 [buffModule](PeakDeskSprite/Dashboard/buffModule.py)
